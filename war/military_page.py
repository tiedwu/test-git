...
class MilitaryPage(Screen):
	...
	cavalryman = 0
	unit = 0
	buttons = {'_unit_one': 1, '_unit_ten': 10, 
		'_unit_hundred': 100, '_unit_thousand': 1000, '_unit_ten_thousand': 10000}

	def set_soldiers(self, soldiers):
		self.lancer = soldiers["lancer"]
		self.shieldman = soldiers["shieldman"]
		self.archer = soldiers["archer"]
		self.cavalryman = soldiers["cavalryman"]
